...
export default function UserCard({
  ...
  return (
    <div
      className={`flex flex-col items-center p-6 border-2 rounded-xl cursor-pointer transition-all duration-300 w-full sm:w-60 h-48 ${bgColor}`}
      onClick={onClick}
      style={{
    ...
    >
      ...
      <h3 className="text-lg font-semibold text-[#4C575F] mb-2 text-center">{title}</h3>
